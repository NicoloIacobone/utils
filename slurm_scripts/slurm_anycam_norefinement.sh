...
python anycam/scripts/anycam_demo.py ++input_path=/cluster/work/igp_psr/niacobone/anycam/examples/nicola.mp4 ++model_path=pretrained_models/anycam_seq8 ++output_path=/cluster/work/igp_psr/niacobone/anycam/examples/results/norefinement ++ba_refinement=false
